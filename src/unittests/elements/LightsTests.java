...
//			new Point3D(-150, -150, -150), new Point3D(-70, 70, -50), new Point3D(75, 75, -150));
	...
	/**
	 * New light for Sphere
	 */
	@Test
	public void sphereNewlight() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(500, 300, 0), new Point3D(-10, -10, 100), new Vector(1, 1, -2)) //
				.setKl(0.00000005).setKq(0.0000000005));

		ImageWriter imageWriter = new ImageWriter("sphereNewlight", 500, 500);
		Render render = new Render()//
				.setImageWriter(imageWriter) //
				.setCamera(camera1) //
				.setRayTracer(new RayTracerBasic(scene1));
...
//			fail();
	...
	/**
	 * New light for Triangle
	 */
	@Test
	public void trianglesNewlight()
	{
		try {
			Geometry triangle1 = new Triangle( //
					new Point3D(-150, -150, -150), new Point3D(150, -150, -150), new Point3D(75, 75, -150));
			...
			scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(50, -50, -130)) //
					.setKl(0.0008).setKq(0.0008));
			scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Point3D(10, -10, -130), new Vector(-2, -2, -1)) //
					.setKl(0.0001).setKq(0.000005));

			ImageWriter imageWriter = new ImageWriter("trianglesNewlight", 500, 500);
			Render render = new Render()//
					.setImageWriter(imageWriter) //
					.setCamera(camera2) //
					.setRayTracer(new RayTracerBasic(scene2));

...
public class Ray {
   ...
   public Intersectable.GeoPoint findClosestGeoPoint(List<Intersectable.GeoPoint> gp)
   {
      double distance=Double.POSITIVE_INFINITY;
      Intersectable.GeoPoint nearPoint=null;
      if(gp!=null) {
         for (Intersectable.GeoPoint geo : gp) {
